...
* AFTER reading the preface and the first two chapters in *Do The Work*: 
	* Write a [response](responses.md) and list of your enemies and allies and upload to a folder labeled "Pre-work" in your project documentation folder for your [end of semester deliverables](end_of_semester_deliverables.md).
