...
* AFTER listening to the podcast, write a [response](responses.md). Identify at least 3 "inputs" for Lindelof in creating watchmen, NOT including the original graphic novel. Identify at least 3 "inputs" for your senior project. Post to slack and upload to your project documentation folder for your [end of semester deliverables](end_of_semester_deliverables.md). 
